        ...
        <div class="home-container">
                ...
                <div class="text-center container">
                    ...
                    <div class="row home-actions justify-content-center">
                        <div class="mx-2 col-5 text-end">
                            <a href="#" class="btn px-4 py-3 btn-secondary btn-lg" target="_self"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="rocket" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="mr-2 svg-inline--fa fa-rocket fa-w-16">
                        ...
                        <div class="mx-2 col-5 text-start">
                            <a href="https://github.com/joomaio/sdm" target="_blank" class="btn px-4 py-3 btn-secondary btn-lg"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="terminal" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="mr-2 svg-inline--fa fa-terminal fa-w-20">
            ...
            <div class="home-features" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                <div>
                    <div class="container">
                        <div class="py-5" >
                            <div class="row py-5">
                                <div class="d-flex justify-content-center col-lg-8 order-lg-2">
                                    <div class="">
                                        <img alt="Công cụ miễn phí" src="<?php echo $config->getImage()[3]; ?>" class="rounded shadow img-fluid" />
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center text-center text-lg-right mt-3 mt-lg-0 col-lg-4 order-lg-1">
                        ...
                        <div class="py-5">
                            <div class="row py-5">
                                <div class="d-flex justify-content-center col-lg-8">
                                    <div class="">
                                        <img alt="Tập chung nhân lực" src="<?php echo $config->getImage()[2]; ?>" class="rounded shadow img-fluid" />
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center text-center text-lg-left mt-3 mt-lg-0 col-lg-4">
                                    <div class="text-start">
                                        <h3>Tập chung thời gian, công việc và con người vào một luồng thời gian</h3>
                                        <p>
                                            SDM có thể giúp bạn tập chung con người và thời gian vào công việc.
                                            <br />Giúp bạn tiết kiệm thời gian và hoàn thành được nhiều công việc hơn.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="py-5">
                            <div class="row py-5">
                                <div class="d-flex justify-content-center col-lg-8 order-lg-2">
                                    <div class="">
                                        <img alt="Đơn giản hóa công việc" src="<?php echo $config->getImage()[4]; ?>" class="rounded shadow img-fluid" />
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center text-center text-lg-right mt-3 mt-lg-0 col-lg-4 order-lg-1">
                                    <div class="text-start">
                        ...
                        <div class="py-5">
                            <div class="row py-5">
                                <div class="d-flex justify-content-center col-lg-8">
                                    <div class="">
                                        <img alt="Giao tiếp với team" src="<?php echo $config->getImage()[5]; ?>" class="rounded shadow img-fluid" />
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center text-center text-lg-left mt-3 mt-lg-0 col-lg-4">
                                    <div class="text-start">
                        ...
                        <div class="py-5">
                            <div class="row py-5">
                                <div class="d-flex justify-content-center justify-content-lg-start col-lg-8 order-lg-2">
                                    <div class="">
                                        <img alt="Upload file dưới nhiều dạng" src="<?php echo $config->getImage()[6]; ?>" class="rounded shadow img-fluid" />
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center text-center text-lg-right mt-3 mt-lg-0 col-lg-4 order-lg-1">
                                    <div class="text-start">
                                        ...
                                        <p>
                                            Bạn có thể upload file dưới nhiều dạng như file ảnh, file pdf, execl, word hay thậm chí là file từ google drive trên SDM
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="" style="background-image:url( <?php echo $config->getImage()[7]; ?> ) !important;">
                        <div class="container">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body home-features d-flex justify-content-between flex-column">
                                            ...
                                            <p class="card-text text-right mt-2">
                                                <a href="https://github.com/joomaio/sdm" target="_blank" class="btn py-2 px-4 btn-secondary" style="background-color: #f8f8f8 !important;">
                                                    Tải xuống ngay
                                                </a>
                                            </p>
                                        </div>
                                ...
                                <div class="my-2 col-4">
                                    <div class="card h-100">
                                        <div class="card-body home-features d-flex justify-content-between flex-column">
                                            ...
                                            <p class="card-text text-right mt-2">
                                                <a href="https://github.com/joomaio/sdm" target="_blank" class="btn py-2 px-4 btn-secondary" style="background-color: #f8f8f8 !important;" target="_self">
                                                    Tải xuống ngay
                                                </a>
                                            </p>
                                        </div>
                                ...
                                <div class="my-2 col-4">
                                    <div class="card h-100">
                                        <div class="card-body home-features d-flex justify-content-between flex-column">
                                            ...
                                            <p class="card-text">
                                                Đây chính là nơi dùng để quản lý các request một cách chi tiết với các công cụ mạnh mẽ
                                                <br>
                                                1. Relate note là nơi bạn có thể thêm các Note vào trong request.
                                                <br>
                                                2. Document là nơi để lưu tài liệu của request. Tại đây bạn cũng có thể chat với những người trong team của bạn
                                ...
                                <div class="my-2 col-4">
                                    <div class="card h-100">
                                        <div class="card-body home-features d-flex justify-content-between flex-column">
                                            ...
                                            <p class="card-text">
                                                3. Task là nơi tạo ra các log công việc của bạn, bạn có thể dán URL của ứng dụng bên thứ 3 vào để sử dụng
                                                <br>
                                                4. Version sẽ tạo ra các change log của request và được tổng hợp lại để hiển thị ra những thay đổi có trong Version của bạn
                                            </p>
                                            <p class="card-text text-right mt-2">
                                                <a href="https://github.com/joomaio/sdm" target="_blank" class="btn py-2 px-4 btn-secondary" style="background-color: #f8f8f8 !important;">
                                                    Tải xuống ngay
                        ...
                        <div class="container">
                            ...
                            <div class="row pt-3 pb-5">
                                <div class="my-2 col-6">
                                    <div class="card h-100">
                                        <div class="card-body d-flex justify-content-between flex-column" style="background-color: #f2f2f2 !important;">
                                            <h4 class="card-title mb-4">
                                                Quản lý Note
                                            </h4>
                                            <p class="card-text">
                                ...
                                <div class="my-2 col-6">
                                    <div class="card h-100">
                                        <div class="card-body d-flex justify-content-between flex-column" style="background-color: #f2f2f2 !important;">
                                            ...
                                            <p class="card-text">
                                                Tích hợp quản lý task từ bên thứ 3 như Odoo, hiển thị các thông tin của task lên giao diện.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="" style="background-image: url(<?php echo $config->getImage()[8]; ?>);">
                    <div class="container">
                        <div class="container">
                            <div class="row py-5">
                                <div class="text-center col">
                                    ...
                                    <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center">
                                        ...
                                        <a href="#" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" class="btn mt-2 mt-lg-0 ml-lg-1 py-2 px-4 btn-secondary">
                                            Liên hệ hỗ trợ
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog  modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" style="background-color: #f2f2f2 !important" data-bs-dismiss="modal">Đóng</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-6">
                        ...
                        <ul>
                            ...
                            <li class="mt-2">
                                <a href="https://github.com/joomaio/sdm" target="_blank" class="btn p-0 border-0 text-left btn-link" target="_self">
                                    Github
                                </a>
                            </li>
                        </ul>
